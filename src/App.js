...
//import heroImage from "./images/butterfly.jpg";
//import heroImage from "./images/lollipop.jpg";
//import heroImage from "./images/tree.jpg";
      ...
      <div class="bg-zinc-800 p-2 mx-6 rounded-2xl w-96">
        ...
        <div class="flex flex-col rounded-l-xl">
          <img
            src={heroImage}
            alt=""
            class="object-cover rounded-xl h-80"
          ...
          <div class="p-6">
            ...
            <div>
              ...
              <div class="flex flex-col mt-5 space-y-4">
                ...
                <button class="px-5 py-3 text-s font-medium rounded-md text-zinc-800 bg-lime-500 hover:bg-lime-700 hover:text-white duration-500" onClick={handleCount}>
                  Count
                </button>
              </div>
            </div>
            ...
            {min && <div class="max-w-xs my-4 text-s leading-8 tracking-wide text-start text-white">
              {/* <div>{currentDateMls - randomDateMls}</div> */}

              <p
              class="font-serif text-l font-medium text-center text-white"
            >
              Your age in
            </p>
              ...
              <div>
                <span>years: </span>
                {Math.floor((currentDateMls - randomDateMls) / 1000 / 3600 / 24 / 365)}
              </div>

              <div>
                <span>months: </span>
                {Math.floor(((currentDateMls - randomDateMls) / 1000 / 3600 / 24 / 365) * 12)}
              </div>
              
              <div>
                <span>days: </span>
                {Math.floor((currentDateMls - randomDateMls) / 1000 / 3600 / 24)}
              </div>             
